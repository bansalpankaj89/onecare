(function() {
    angular.module('mediDocApp.controller').controller('settingsController', 
        ['$scope', '$ionicModal', 'diagnosisService','procedureService' , settingsController]);
    
    function settingsController($scope, $ionicModal, diagnosisService, procedureService) {
        //code goes here   
       /* var vm = this;
        vm.mode = 'create';
        ...
        vm.loadDiagnosis = function() {            
                ...
                .then(function(result) {
                    ...
                    console.error('Error - settingsController - loadDiagnosis ', err);
                })
        };
        ...
        vm.loadProcedure = function() {            
                ...
                .then(function(result) {
                    ...
                    console.error('Error - settingsController - loadProcedure ', err);
                })
        };
        ...
        vm.saveDiagnosis = function() {
            if(vm.mode == 'create') {
                ...
                .then(function(result) {
                    ...
                    console.error('Error - settingsController - createDiagnosis ', err);
                });
            } else {
                ...
                .then(function(result) {
                    ...
                    console.error('Error - settingsController - updateDiagnosis ', err);
                });
            }
        }    
        ...
        vm.saveProcedure = function() {
            if(vm.mode == 'create') {
                ...
                .then(function(result) {
                    ...
                    console.error('Error - settingsController - createProcedure ', err);
                });
            } else {
                ...
                .then(function(result) {
                    ...
                    console.error('Error - settingsController - updateProcedure ', err);
                });
            }
        }   
