(function() {
    ...
    .factory('medicalExaminationTaskManagerService', medicalExaminationTaskManagerService);
    
    medicalExaminationTaskManagerService.$inject = ['$q', 'medicalExaminationService', 'taskService', 'workorderService', 'taskDetailService']
    
    function medicalExaminationTaskManagerService($q, medicalExaminationService, taskService, workorderService, taskDetailService) {    
